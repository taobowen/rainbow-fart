...
```
结果：
![image](https://user-images.githubusercontent.com/46807600/57746877-ae0adc80-7705-11e9-87c9-2231555d80d5.png)
...
`console.log(Book);`
结果：
![image](https://user-images.githubusercontent.com/46807600/57746933-ed392d80-7705-11e9-9fbe-f21a81b189bf.png)
乍一看，是不是跟我们在上面打印vue数据长得有点类似，说明vue确实是通过这种方法来进行数据劫持的。接下来我们通过其原理来实现一个简单版的mvvm双向绑定代码。
**思路分析**
实现mvvm主要包含两个方面，数据变化更新视图，视图变化更新数据：
![image](https://user-images.githubusercontent.com/46807600/57746954-08a43880-7706-11e9-9ba6-b15a55333a8f.png)
...
![image](https://user-images.githubusercontent.com/46807600/57746965-178aeb00-7706-11e9-9dbf-a8c2ca0aa1c0.png)
思路有了，接下去就是实现过程了。
...
流程图如下：
![image](https://user-images.githubusercontent.com/46807600/57746980-27a2ca80-7706-11e9-9e30-29f5e14f3f6b.png)
**1.实现一个Observer**
